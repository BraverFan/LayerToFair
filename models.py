...
class BankModel(nn.Module):
    def __init__(self, p=0.2):
        ...
        self.layer2 = nn.Linear(in_features=64, out_features=128)
        self.layer3 = nn.Linear(in_features=128, out_features=256)
        self.layer4 = nn.Linear(in_features=256, out_features=128)
        self.layer5 = nn.Linear(in_features=128, out_features=64)
        self.layer6 = nn.Linear(in_features=64, out_features=32)
        # self.layer7 = nn.Linear(in_features=128, out_features=128)
...
#     def __init__(self, p=0.1):
#         super().__init__()
#         self.layer1 = nn.Linear(in_features=30, out_features=32)
...
#     def __init__(self, p=0.1):
#         super().__init__()
#         self.layer1 = nn.Linear(in_features=138, out_features=256)
...
#         self.layer6 = nn.Linear(in_features=32, out_features=32)
#         self.layer7 = nn.Linear(in_features=32, out_features=16)
#         self.layer8 = nn.Linear(in_features=16, out_features=8)
#         self.layer9 = nn.Linear(in_features=8, out_features=1)
#         self.dropout = nn.Dropout(p=p)
#         self.relu1 = nn.ReLU()
#         self.relu2 = nn.ReLU()
#         self.relu3 = nn.ReLU()
