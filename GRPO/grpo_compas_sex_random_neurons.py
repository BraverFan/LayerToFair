...
if __name__ == "__main__":
    ...
    for model_path in model_paths:
        ...
        save_dir = f"Ablation experiment/Compas_sex_random_neurons"
        os.makedirs(save_dir, exist_ok=True)

        save_path = os.path.join(save_dir, f"{seed}_{layers_mode}_{neurons_mode}_{max_time_minutes}_hello.json")
