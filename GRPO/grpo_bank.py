...
if __name__ == "__main__":
    ...
    model_paths = [
       ...
       # 'bank-0.5484-3968592-ss-0.2.pt',
       # 'bank-0.5498-67802376-ss-0.2.pt',
       # 'bank-0.5488-95489543-ss-0.2.pt',
       # 'bank-0.5371-48689224-ss-0.2.pt',
       # 'bank-0.5288-578297398-ss-0.2.pt',
       # 'bank-0.5489-397895609-ss-0.2.pt',
       # 'bank-0.5538-784290901-ss-0.2.pt',
    ...
    for model_path in model_paths:
        ...
        print("强化学习之前的sens_val", sens_val)#这里是[0.2222, 0.3333, 0.2222,  ..., 0.1111, 0.3333, 0.3333]，而在linux上是[0., 1., 0.,  ..., 0., 1., 1.]
