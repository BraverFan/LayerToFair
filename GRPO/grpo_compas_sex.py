...
from utils import compute_metrics, convert_to_builtin_types, preprocess_compas
...
if __name__ == "__main__":
    ...
    model_paths = [
        # 'compas-0.9670-4712983-mms-0.1.pt',
        # 'compas-0.9719-7235204-mms-0.1.pt',
        # 'compas-0.9673-73453489-mms-0.1.pt',
        # 'compas-0.9695-28590490-mms-0.1.pt',
        # 'compas-0.9698-84659028-mms-0.1.pt',
        # 'compas-0.9667-58203907-mms-0.1.pt',
        # 'compas-0.9667-678234526-mms-0.1.pt',
        # 'compas-0.9709-39874389-mms-0.1.pt',
        # 'compas-0.9602-99994378-mms-0.1.pt',
        'compas-0.9680-1123428-mms-0.1.pt',
        'compas-0.9655-2234586-mms-0.1.pt',
        'compas-0.9633-173839823-mms-0.1.pt',
        'compas-0.9687-1945898-mms-0.1.pt',
        'compas-0.9693-13020202-mms-0.1.pt',
    ]
    for model_path in model_paths:
        ...
        _, X_val, _, y_val, sens_idx = preprocess_compas(seed, attr)
        ...
        state_dict = torch.load(f"../saved_models/compas_base/{model_path}", map_location=torch.device('cpu'))
        ...
        # 需要获取key neurons
        hyperparameter_search_type = "GridSearch"  # RandomSearch or GridSearch
        start_time = time.time()
        ...
        save_dir = f"intermediate results/Compas_sex"
        ...
        # layer_name_keys = list(key_neurons.keys())#全部层
