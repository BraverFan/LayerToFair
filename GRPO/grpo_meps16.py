...
if __name__ == "__main__":
    ...
    model_paths = [
                    'meps-0.5047-42-mms-0.1.pt',
                            'meps-0.5116-398198020-mms-0.1.pt',
                                    'meps-0.5109-36821596-mms-0.1.pt',
                                            'meps-0.5364-2579600519-mms-0.1.pt',
                                                    'meps-0.5135-3569605705-mms-0.1.pt',
                                                            'meps-0.5023-608130088-mms-0.1.pt',
                                                                    'meps-0.5166-2123741781-mms-0.1.pt',
                                                                            'meps-0.5256-498349121-mms-0.1.pt',
                                                                                    'meps-0.5261-523624893-mms-0.1.pt',
                                                                                            'meps-0.5056-982938842-mms-0.1.pt',
                                                                                                ]
    sens_classes_dict = {
    ...
    for model_path in model_paths:
        ...
        save_dir = f"intermediate results/Meps16"
