...
if __name__ == "__main__":
    ...
    model_paths = [
        ...
        # 'compas-0.9632-128934883-mms-0.1.pt',
        ...
        # 'compas-0.9653-67348201-mms-0.1.pt',
        ...
        # 'compas-0.9705-1992418063-mms-0.1.pt',
        # 'compas-0.9655-3192103970-mms-0.1.pt',
        # 'compas-0.9650-233313873-mms-0.1.pt',
        # 'compas-0.9664-1994190001-mms-0.1.pt',

        #'compas-0.9682-2193280764-mms-0.1.pt',563530960
    ...
    for model_path in model_paths:
        ...
        policy_net.load_state_dict(torch.load("policy_net_compas_race_val.pth"))
