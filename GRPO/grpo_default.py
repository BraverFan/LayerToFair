...
if __name__ == "__main__":
    ...
    model_paths = [
        'default-0.5060-123458927-mms-0.2.pt',
        'default-0.4883-385692-mms-0.2.pt',
        'default-0.4890-6578812-mms-0.2.pt',
        'default-0.4982-467892-mms-0.2.pt',
        'default-0.4819-72982494-mms-0.2.pt',
        'default-0.4858-72198034-mms-0.2.pt',
        'default-0.4972-218938-mms-0.2.pt',
        'default-0.5025-828932-mms-0.2.pt',
        'default-0.4802-9927389-mms-0.2.pt',
        'default-0.4820-908248-mms-0.2.pt',
        'default-0.4972-8459289-mms-0.2.pt',
        'default-0.5104-38435893-mms-0.2.pt',
    ]
    for model_path in model_paths:
        ...
        save_dir = f"intermediate results/Default"
