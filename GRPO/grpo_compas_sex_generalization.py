...
if __name__ == "__main__":
    ...
    model_paths = [
        ...
        # 'compas-0.9658-48892839-mms-0.1.pt',
        # 'compas-0.9700-813498128-mms-0.1.pt',
        # 'compas-0.9700-813498128-mms-0.1.pt',
        # 'compas-0.9701-87654321-mms-0.1.pt',
        # 'compas-0.9729-20250607-mms-0.1.pt',
        # 'compas-0.9653-20262025-mms-0.1.pt',
        # 'compas-0.9741-20001013-mms-0.1.pt',
    ...
    for model_path in model_paths:
        ...
        save_path = os.path.join(save_dir, f"{seed}_{layers_mode}_{neurons_mode}_{max_time_minutes}_dropout.json")
        ...
        torch.save(policy_net.state_dict(), "policy_net_compas_sex_val.pth")
        ...
        hidden_dim = action_dim
        policy_net = PolicyNet(obs_dim, action_dim, hidden_dim)
        policy_net.load_state_dict(torch.load("policy_net_compas_sex_val.pth"))

        # # 微调时只对最后一层进行微调
        # for param in policy_net.parameters():
        #     param.requires_grad = False
        # for param in policy_net.fc_mean.parameters():
        #     param.requires_grad = True

        start_time = time.time()
        repaired_eod_test, repaired_f1_test, _, _, best_fairness_list_test, _ = train_grpo(
            env_fine_tune,
            max_time_minutes=0.1,
            batch_size=10,
            lr=0.002,
            n_iterations=10,
            eps=0.2,
