...
from models_causal import CompasModel
...
from utils import compute_metrics, convert_to_builtin_types, preprocess_compas, localize
import json
import os
...
if __name__ == "__main__":
    ...
    for model_path in model_paths:
        ...
        save_dir = f"Ablation experiment/Compas_sex_causal_neurons"
