...
if __name__ == "__main__":
    ...
    for model_path in model_paths:
        ...
        # 需要获取key neurons
        hyperparameter_search_type = "RandomSearch"
        start_time = time.time()
        ...
        save_dir = f"intermediate results/Adult_sex"
        ...
        # 保存模型
        torch.save(policy_net.state_dict(), "policy_net_adult_sex_val.pth")
        torch.save(value_net.state_dict(), "value_net_adult_sex_val.pth")
        ...
        policy_net_finetune.load_state_dict(torch.load("policy_net_adult_sex_val.pth"))

        value_net_finetune = ValueNet(obs_dim, hidden_dim)
        value_net_finetune.load_state_dict(torch.load("value_net_adult_sex_val.pth"))
