...
if __name__ == "__main__":
    ...
    model_paths = [
        ...
        'default-0.4968-72938429-mms-0.2.pt',
        'default-0.4889-444291911-mms-0.2.pt',
        'default-0.4982-39040222-mms-0.2.pt',
        'default-0.5171-5123440-mms-0.2.pt',
        'default-0.5106-98298388-mms-0.2.pt',
        'default-0.5137-64782942-mms-0.2.pt',
        'default-0.5014-333912894-mms-0.2.pt',
    ]
    for model_path in model_paths:
        ...
        torch.save(policy_net.state_dict(), "policy_net_default_val.pth")
        ...
        policy_net.load_state_dict(torch.load("policy_net_default_val.pth"))
