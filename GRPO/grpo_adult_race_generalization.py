...
if __name__ == "__main__":
    ...
    model_paths = [
        ...
        # 'adult-0.6927-47729329-ss-0.2.pt',
    ...
    for model_path in model_paths:
        ...
        layer_sizes_accuracy, key_neurons, total_train_time = (
           ...
           sens_idx, threshold, hyperparameter_search_type,"adult-race").identify())
        ...
        torch.save(policy_net.state_dict(), "policy_net_adult_race_val.pth")
        ...
        policy_net.load_state_dict(torch.load("policy_net_adult_race_val.pth"))
