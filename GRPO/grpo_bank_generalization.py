...
if __name__ == "__main__":
    ...
    model_paths = [
        # 'bank-0.5617-729348234-ss-0.4.pt',
        # 'bank-0.5471-934827-ss-0.3.pt',
        # 'bank-0.5706-3989056-ss-0.3.pt',
        # 'bank-0.5709-298378924-ss-0.4.pt',
        # 'bank-0.5741-385491921-ss-0.4.pt',
        # 'bank-0.5893-77773292-ss-0.4.pt',
        # 'bank-0.5559-289939112-ss-0.3.pt',

        # 'bank-0.5836-20250708-ss-0.4.pt',
        # 'bank-0.5568-98392834-ss-0.4.pt',
        # 'bank-0.5918-654321-ss-0.4.pt',
        # 'bank-0.5691-30048091-ss-0.4.pt',
        # 'bank-0.5603-20182019-ss-0.4.pt',

        'bank-0.5760-289395393-ss-0.4.pt',
        'bank-0.5903-902932349-ss-0.4.pt',
        'bank-0.5636-82932321-ss-0.4.pt',
        'bank-0.5716-198723847-ss-0.5.pt',
    ...
    for model_path in model_paths:
        ...
        policy_net.load_state_dict(torch.load("policy_net_bank_val.pth"))
