...
from utils import compute_metrics, convert_to_builtin_types, preprocess_adult_census, compute_neuron_forward_impact
import json
import os
...
if __name__ == "__main__":
    ...
    for model_path in model_paths:
        ...
        impact_tuples_sorted = compute_neuron_forward_impact(model, X_val, key_layers_num=4)
