...
if __name__ == "__main__":
    ...
    for model_path in model_paths:
        ...
        torch.save(value_net.state_dict(), "value_net_default_val.pth")
        ...
        policy_net_finetune.load_state_dict(torch.load("policy_net_default_val.pth"))

        value_net_finetune = ValueNet(obs_dim, hidden_dim)
        value_net_finetune.load_state_dict(torch.load("value_net_default_val.pth"))
