...
from utils import compute_metrics, convert_to_builtin_types, preprocess_default, compute_neuron_forward_impact
...
if __name__ == "__main__":
    ...
    for model_path in model_paths:
        ...
        impact_tuples_sorted = compute_neuron_forward_impact(model, X_val, key_layers_num=2)
        ...
        save_path = os.path.join(save_dir, f"{seed}_{layers_mode}_{neurons_mode}_{max_time_minutes}_again.json")
