...
if __name__ == "__main__":
    ...
    model_paths = [
      ...
      'compas-0.9654-8894782-mms-0.1.pt',
      'compas-0.9710-88578234-mms-0.1.pt',
       'compas-0.9681-11039402-mms-0.1.pt',
       'compas-0.9623-65845832-mms-0.1.pt',
       'compas-0.9660-923728345-mms-0.1.pt',
       'compas-0.9681-78353748-mms-0.1.pt',
    ]
    for model_path in model_paths:
        ...
        save_dir = f"Ablation experiment/Compas_sex_hyp_threshold"
        os.makedirs(save_dir, exist_ok=True)

        save_path = os.path.join(save_dir, f"{seed}_{layers_mode}_{neurons_mode}_{max_time_minutes}_0.03threshold.json")
