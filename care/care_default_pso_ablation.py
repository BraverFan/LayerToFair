...
import os
import numpy as np
from models_causal import DefaultModel
import torch
from utils import preprocess_default, compute_metrics, convert_to_builtin_types
import pyswarms
import time
...
def main():
    ...
    for model_path in model_paths:
        ...
        save_dict = {
            "time for localize neurons with causal:": identification_time,
        ...
        save_dir = f"causal_results/Default"
        ...
        for layer in layer_name_keys:
            localize_neurons.extend((layer, i) for i in key_neurons[layer])
        repair_neurons_num = len(localize_neurons)
        print("localize neurons", localize_neurons)
        print("repair_neurons_num", repair_neurons_num)
